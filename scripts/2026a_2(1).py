...
def pso_optimize(bounds, C_in, Q, n_particles=80, max_iter=200,
    ...
    for i in range(n_particles):
        ...
        penalty = max(0, c_out - 10.0) * penalty_weight   # 超过10才惩罚
...
def main():
    ...
    result_df.to_csv(r"C:\Users\24070\Desktop\question2_PSO_results.csv", index=False)
    return result_df
...
def local_refine(x0, C_in, Q, bounds_list):
    ...
    def con_cout(x):
        U = x[:4]
        T = x[4:8]
        return 10.0 - c_out_pred(U, T, C_in, Q)
