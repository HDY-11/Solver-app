...
def main():
    ...
    log_path = r"C:\Users\24070\Desktop\optimization_full_log4.txt"
    with open(log_path, 'w', encoding='utf-8') as f:
        ...
        result_df.to_csv(r"C:\Users\24070\Desktop\full_results4.csv", index=False)
        ...
        sens_df.to_csv(r"C:\Users\24070\Desktop\sensitivity_analysis4.csv", index=False)
        print("灵敏度分析完成，结果已保存。")
        f.write("灵敏度分析完成。\n")
